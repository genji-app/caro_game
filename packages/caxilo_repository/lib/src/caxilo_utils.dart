/// {@template caxilo_utils}
/// Utility class for caxilo repository data processing.
/// {@endtemplate}
class CaxiloUtils {
  ...
  String slugify(String text) {
    ...
    return normalized
        ...
        .replaceAll(RegExp(r'[^a-z0-9\-]'), '') // Keep only alphanumeric and hyphen
        .replaceAll(RegExp(r'-+'), '-') // Replace consecutive hyphens with single
