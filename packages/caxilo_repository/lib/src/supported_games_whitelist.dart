...
class SupportedGamesWhitelist {
  ...
  String get filterMode => _testMode ? 'TEST MODE (All games)' : 'PRODUCTION MODE (Filtered)';
  ...
  Set<String> get supportedProviders => _testMode ? {} : _whitelist.keys.toSet();
  ...
  Map<String, dynamic> getConfigInfo() {
    return {
      ...
      'totalWhitelistedGames': _whitelist.values.fold(0, (sum, games) => sum + games.length),
