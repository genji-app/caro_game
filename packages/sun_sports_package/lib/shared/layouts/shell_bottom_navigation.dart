...
import 'package:sun_sports/features/profile/profile_router.dart';
import 'package:sun_sports/features/sport/presentation/tablet/widgets/sport_tablet_bottom_navigation.dart';
import 'package:sun_sports/features/wallet/wallet_balance_view.dart';
import 'package:sun_sports/shared/layouts/shell_desktop_sidebar.dart';
import 'package:sun_sports/shared/profile_navigation_system/src/profile_navigation.dart';
  ...
  void _handleItemSelected(BuildContext context, WidgetRef ref, int index) {
    ...
    switch (item) {
      ...
      case BottomNavigationItem.sun247:
        // Mobile/tablet: né embed WebView/iframe (WKWebView release iOS bị
        // blank, Safari web compositing nuốt mất Flutter widgets) — launch
        // LiveChat URL ra external browser. Không gọi goToSun247() nên
        // mainContentProvider không đổi → bottom nav index giữ nguyên tab
        // hiện tại.
        if (widget.isMobile) {
          launchUrl(
