...
import 'package:sun_sports/shared/widgets/sport/match/score/basketball_score_section.dart';
import 'package:sun_sports/shared/widgets/sport/match/score_header_config.dart';

/// Basketball match row — vertical stacked layout:
/// Header:  [Live] Q2 | timecount    Q1 | Q2 | H1 | Q3 | Q4 | Tổng
/// Score:   Teams                     scores per quarter + total
/// Odds:    Đội thắng | Chấp | Tài/Xỉu (independent section)
/// Footer:  shared
class MatchRowBasketballV2 extends ConsumerWidget {
  final EventModelV2 event;
  final LeagueModelV2? league;
  final bool isDesktop;

  const MatchRowBasketballV2({
    required this.event,
    this.league,
  ...
  static final _config = ScoreHeaderConfig.forSport(2);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Score row: teams (Expanded) + score grid (fixed-width)
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                BasketballScoreSection(event: event, isDesktop: isDesktop),
              ],
            ),
          ),
