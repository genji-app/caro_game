...
class HintStyledTags {
  ...
  static Map<String, StyledTextTag> get tags {
    ...
    return {
      ...
      // Result Tags
      // ========================================
      /// Win result tag - Green (matches the V1 bubble winColor)
      'win': StyledTextTag(
        style: base.copyWith(
      ...
      /// Lose result tag - Red (matches the V1 bubble loseColor)
      'lose': StyledTextTag(
        style: base.copyWith(
