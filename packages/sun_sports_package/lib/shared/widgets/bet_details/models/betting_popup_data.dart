...
class BettingPopupData {
  ...
  /// Handicap points string from the SELECTED team's perspective.
  ///
  /// The API field `points` is given from the Home team's perspective. For an
  /// Away handicap selection the sign is flipped so the displayed value
  /// matches the team it is shown next to.
