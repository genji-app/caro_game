...
class SbConfig {
  ...
  /// Sun88 brand config URL — resolved theo [AppEnv] (staging/prod).
  ...
  void applyBrandConfig(Map<String, dynamic> config) {
    ...
    if (config['cdn_videos'] != null)
      cdnVideos = config['cdn_videos'] as String;
    if (config['game_api_url'] != null)
      gameApiUrl = config['game_api_url'] as String;
    if (config['games_url'] != null) gamesUrl = config['games_url'] as String;
