...
@JsonKey(name: 'soi') String? get offerId;/// Odds bị suspended (kèo rung / tạm khóa) - không cho đặt cược.
/// KHÔNG gắn @JsonKey: bet detail dựng LeagueOddsData qua constructor
/// (v2_to_legacy_adapter / socket), không qua fromJson. Nếu sau này cần
/// parse từ list API qua fromJson thì bổ sung `@JsonKey(name: ...)`.
 bool get isSuspended;/// Home Odds Object (API: oh) - contains {ma, in, de, hk}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,points,isMainLine,selectionHomeId,selectionAwayId,selectionDrawId,offerId,isSuspended,oddsHome,oddsAway,oddsDraw,homeOddsLegacy,awayOddsLegacy,drawOddsLegacy,offerIdLegacy,selectionIdLegacy);
...
switch (_that) {
case _LeagueOddsData():
return $default(_that.points,_that.isMainLine,_that.selectionHomeId,_that.selectionAwayId,_that.selectionDrawId,_that.offerId,_that.isSuspended,_that.oddsHome,_that.oddsAway,_that.oddsDraw,_that.homeOddsLegacy,_that.awayOddsLegacy,_that.drawOddsLegacy,_that.offerIdLegacy,_that.selectionIdLegacy);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
/// Odds bị suspended (kèo rung / tạm khóa) - không cho đặt cược.
/// KHÔNG gắn @JsonKey: bet detail dựng LeagueOddsData qua constructor
/// (v2_to_legacy_adapter / socket), không qua fromJson. Nếu sau này cần
/// parse từ list API qua fromJson thì bổ sung `@JsonKey(name: ...)`.
