...
import 'package:sun_sports/features/profile/withdraw/domain/providers/withdraw_providers.dart';
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      result.fold(
        ...
        // Success
        (response) {
          // Refresh user balance after successful card withdraw submit
          // (status=0). Mirrors GamePlayManager.sendRefreshMoney() in
          // TheCaoTopupView.ts. Fire-and-forget — balance fetch should not
