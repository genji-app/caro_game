...
class CardFormNotifier extends StateNotifier<CardFormState> {
  ...
  /// Clear only the text-input fields (serial number + card code) and their
  /// validation errors. Used when the form is re-opened so leftover values
  /// from a previous deposit attempt never appear in the inputs while the
  /// user's [selectedCardType] / [selectedDenomination] choices are kept.
