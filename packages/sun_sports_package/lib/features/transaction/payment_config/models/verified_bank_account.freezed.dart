...
/// Create a copy of VerifiedBankAccount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accountHolder = freezed,Object? bankId = freezed,Object? accountNo = freezed,}) {
...
class _VerifiedBankAccount implements VerifiedBankAccount {
  const _VerifiedBankAccount({@JsonKey(name: 'accountHolder') this.accountHolder, @JsonKey(name: 'bankId') this.bankId, @JsonKey(name: 'accountNo') this.accountNo});
...
/// Create a copy of VerifiedBankAccount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accountHolder = freezed,Object? bankId = freezed,Object? accountNo = freezed,}) {
