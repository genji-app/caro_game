...
/// Section "Top nhà cung cấp" — 3 card cho 3 NCC sportbook (KSport / Saba / BTI).
/// Design Figma node 11708:43840. Layout tham khảo [HomeDesktopSportsSection].
class HomeDesktopNccSection extends ConsumerWidget {
  ...
  // Kích thước card gốc theo Figma (232x160) — mọi số đo bên trong scale
  // theo bề rộng card thực tế để co giãn đồng đều thay vì fix cứng.
  static const double _designCardWidth = 232;
  static const double _cardAspectRatio = 232 / 160;

  // Tỉ lệ chiều cao lớp gradient phủ dưới so với card (126/160 theo Figma).
  static const double _overlayHeightFactor = 126 / 160;
