...
import 'package:sun_sports/core/services/providers/live_events_provider.dart';
...
/// Live Event desktop screen – hiển thị các trận đấu đang diễn ra.
...
class LiveEventDesktopScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Không bọc Expanded: shell desktop đã bọc Expanded(ShellContentSwitcher).
    return Container(
  ...
  /// S88Tab sport tabs – cùng style với TopLeagueDesktopScreen.
