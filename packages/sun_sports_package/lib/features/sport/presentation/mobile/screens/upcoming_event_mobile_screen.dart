...
import 'package:sun_sports/core/services/providers/events_v2_filter_provider.dart';
import 'package:sun_sports/core/services/providers/upcoming_events_provider.dart';
...
/// Màn Sắp diễn ra trên mobile – cấu trúc giống TopLeagueMobileScreen:
/// ShellMobileHeader, _StickyLiveChatDelegate, title, list trận đấu sắp diễn ra.
class UpcomingEventMobileScreen extends ConsumerWidget {
  const UpcomingEventMobileScreen({super.key, this.onBackPressed});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: _UpcomingEventMobileContent(onBackPressed: onBackPressed),
    );
  }
}

class _UpcomingEventMobileContent extends ConsumerStatefulWidget {
  const _UpcomingEventMobileContent({this.onBackPressed});

  final VoidCallback? onBackPressed;

  @override
  ConsumerState<_UpcomingEventMobileContent> createState() =>
      _UpcomingEventMobileContentState();
}

class _UpcomingEventMobileContentState
    extends ConsumerState<_UpcomingEventMobileContent> {
