...
import 'package:sun_sports/core/services/providers/market_status_provider.dart';
...
export 'package:sun_sports/shared/widgets/sport/bet/bet_card_sport.dart'
    show BetCardSport;
...
class _BetCardMobileState extends ConsumerState<BetCardMobile>
  ...
  bool _isOddsLocked(WidgetRef ref) {
    ...
    // 3. CHECK ODDS LEVEL
    // Odds bị suspended (kèo rung / tạm khóa) → Lock riêng odds đó.
    // isSuspended được merge từ API v2 + WebSocket vào LeagueOddsData.
  ...
  Widget build(BuildContext context) {
    ...
    // Kèo rung (vibrating odds) - lấy trạng thái từ provider driven bởi WebSocket
          ...
          child: GestureDetector(
            ...
            child: Stack(
              ...
              children: [
                ...
                // Kèo rung (vibrating odds) - Rive animation overlay
  ...
  Future<void> _handleTap(
    ...
    if (widget.bettingPopupData != null) {
      ...
      // Kèo rung: luôn mở popup trực tiếp, không xử lý logic phiếu cược
      final isVibrating = widget.selectionId != null
