...
import 'package:sun_sports/core/services/adapters/sport_socket_adapter.dart';
...
import 'package:sun_sports/core/utils/audio_manager.dart';
...
import 'package:sun_sports/core/utils/web_icon_preloader.dart';
...
import 'package:sun_sports/features/landing/presentation/landing_page.dart';
import 'package:sun_sports/features/profile/deposit/domain/utils/deposit_storage.dart';
    ...
    Widget buildBaseApp(BuildContext context, Widget child) {
      return FullscreenGuard(
        ...
        gateBuilder: (context, onProceed, onCancel) => FullscreenGateView(
          ...
          subtitle:
              'Để có trải nghiệm tốt nhất, vui lòng kích hoạt '
...
/// Gọi preload game (phase 2) khi vào màn chính — chạy nền, không chặn UI.
