...
class CaxiloGameBlockInHouse implements CaxiloGameBlock {
  const CaxiloGameBlockInHouse({required this.providerId, required this.providerName, required this.image, required this.productId, required this.gameCode, required this.gameName, required this.lang, @JsonKey(fromJson: GameType.fromJson, toJson: GameType.staticToJson) required this.gameType, @GameOrientationListConverter() final  List<caxiloconfig.GameOrientation> mobileOrientation = caxiloconfig.GameOrientation.landscape, @GameOrientationListConverter() final  List<caxiloconfig.GameOrientation> tabletOrientation = caxiloconfig.GameOrientation.all, @GameOrientationListConverter() final  List<caxiloconfig.GameOrientation> desktopOrientation = caxiloconfig.GameOrientation.all, this.loadStopDebounce, this.sortOrder = 999, this.enableHostMessage = false, final  String? $type}): _mobileOrientation = mobileOrientation,_tabletOrientation = tabletOrientation,_desktopOrientation = desktopOrientation,$type = $type ?? 'inHouse';
