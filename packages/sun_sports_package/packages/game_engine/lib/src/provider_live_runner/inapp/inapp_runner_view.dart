  ...
  Widget build(BuildContext context) {
    return InAppWebView(
      ...
      initialSettings: InAppWebViewSettings(
        ...
        // Transparent background prevents the native WebView from flashing white
        // during orientation changes and before the game page finishes rendering.
        // Flutter's loading overlay (rendered below the platform view in Z-order)
        // shows through the transparent native view.
