  ...
  "provider_configs": {
    ...
    */
    "via-casino-vn": {
      "game_type": "live",
      "mobile_orientation": ["portrait"],
      // "tablet_orientation": ["landscapeRight"], // old: first version
      // "tablet_orientation": ["all"], // able
      // "tablet_orientation": ["landscape"],
      "tablet_orientation": ["portrait"],
      "desktop_orientation": ["all"],
    ...
    */
    "vivo": {
      "game_type": "live",
      "mobile_orientation": ["portrait"],
      // "mobile_orientation": ["all"],
      // "tablet_orientation": ["landscape"],
      // "tablet_orientation": ["portrait"],
      "tablet_orientation": ["all"],
      "desktop_orientation": ["all"],
      "open_in_new_tab_on_ios_safari_web": true,
      "games": [
        {
