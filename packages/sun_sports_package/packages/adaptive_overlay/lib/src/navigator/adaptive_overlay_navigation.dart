...
class _AdaptiveOverlayNavigationState extends State<AdaptiveOverlayNavigation> {
  ...
  Widget _buildNavigatorContent() {
    ...
    // Navigator tạo mới mỗi lần overlay mở.
    // OverlayVisibilityGate xử lý mount/unmount.
    // AnimatedBuilder.child caching (trong AnimatedOverlay) ngăn rebuild mỗi frame.
